package com.imooc.firstappdemo.framework.shiro.controller;
...
public class ShiroController {
    ...
    public String doLogin(HttpServletRequest request, Map<String,Object> map){
        ...
        System.out.println("ShiroController.remeberMe?"+currentUser.isRemembered());
        System.out.println("ShiroController.Authenticationed??"+currentUser.isAuthenticated());
